...
- [Headless Ubuntu/Xfce container with VNC/noVNC and configurable Firefox](#headless-ubuntuxfce-container-with-vncnovnc-and-configurable-firefox)
  - [accetto/ubuntu-vnc-xfce-firefox-plus](#accettoubuntu-vnc-xfce-firefox-plus)
...
**Tip** Unless you need the [nss_wrapper][nsswrapper], you can also use the **second generation** (G2) image image [accetto/xubuntu-vnc-novnc-firefox][accetto-docker-xubuntu-vnc-novnc-firefox], which is a streamlined version of this image ([image hierarchy][accetto-xubuntu-vnc-novnc-wiki-image-hierarchy]). The image supports also the **sudo** command.
...
This repository contains resources for building a Docker image based on [Ubuntu 18.04 LTS][docker-ubuntu] with [Xfce][xfce] desktop environment, **VNC**/[noVNC][novnc] servers for headless use and the current [Firefox][firefox] web browser with pre-configuration support.
...
**This image** `accetto/ubuntu-vnc-xfce-firefox-plus` adds the [Firefox Browser][firefox] with customization support to the base image [ubuntu-vnc-xfce][accetto-github-ubuntu-vnc-xfce].
...
[screenshot-container]: https://raw.githubusercontent.com/accetto/ubuntu-vnc-xfce/master/docker/ubuntu-vnc-xfce-firefox-plus/ubuntu-vnc-xfce-firefox-plus.jpg
